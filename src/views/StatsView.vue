  ...
  <div class="page">
    ...
    <div class="card level-card">
      ...
      <div class="level-info">
        ...
        <div class="level-bar">
          <div class="level-fill" :style="{ width: levelPct + '%', background: currentLevel.color }"></div>
        </div>
...
function barColor(d) {
  ...
  if (p >= 80) return '#00d4aa'; if (p >= 50) return '#f59e0b'; if (p > 0) return '#6c63ff'; return '#374151'
}
...
const currentLevel = computed(() => { let l = LEVELS[0]; for (const lvl of LEVELS) { if (totalPts.value >= lvl.min) l = lvl } return l })
